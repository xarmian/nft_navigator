                ...
                <div class="flex flex-row pl-4 justify-between mt-auto w-full pt-4">
                    <div class="flex flex-row space-x-4">
                        ...
                        <div>
                            ...
                            <div class="text-lg text-blue-300 hover:text-blue-200"><a href='https://voi.observer/explorer/account/{collection?.creator}' target="_blank">{collection?.creator.substring(0,8)}...</a></div>
                        </div>
                    </div>
                </div>
            </div>
