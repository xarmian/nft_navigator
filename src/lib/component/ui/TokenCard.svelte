                    ...
                    <Card class="flex justify-between" style="height: 315px;width:290px;">
                        ...
                        <div class="flex justify-evenly">
                            <div class="text-center">
                                <button class="cursor-pointer p-1 bg-blue-400 hover:bg-blue-500 text-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 w-16 ml-1 mr-1" on:click|stopPropagation|preventDefault={() => window.open(marketurl,'_blank')}>
